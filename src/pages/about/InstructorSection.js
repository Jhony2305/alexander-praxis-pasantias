                    ...
                    <div className="col-lg-6 col-md-4 col-sm-6">
                        <div className="instructor__content instructor__content-one">
                            <div className="instructors_lefts">
                                <h6 className="wow animate__fadeInUp" data-wow-duration="0.3s">Planta Docente Quito</h6>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-md-4 col-sm-6">
                        <div className="instructor__content instructor__content-one">
                            <div className="instructors_lefts">
                                <h6 className="wow animate__fadeInUp" data-wow-duration="0.3s">Planta Docente Guayaquill</h6>
                                <h2 className="wow animate__fadeInUp" data-wow-duration="0.5s">Conoce a <br/> Nuestros Docentes</h2>
                            </div>
                        </div>
                    </div>
